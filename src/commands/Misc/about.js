		...
		const embed = new MessageEmbed()
			...
			.setDescription(`- [Dashboard](${bot.config.websiteURL})
				...
				- [Bot Support Server](${bot.config.SupportServer.link})
					${bot.user.username} is a fully customizable Discord Bot. This bot comes fully packed with a wide range of commands, an advanced moderation system and an extensive logging system. Be sure to join the support server for help and up-to-date bot information!`)
